...
//useEffect untuk fetch transaksi seller
  useEffect(() => {
  ...
  //useEffect untuk ambil data" produk 
  useEffect(() => {
  ...
  return (
    <>
      <div>
        ...
        {homeState.isLogin ? (
          <NavbarAfterLogin dataTransaksi={props.dataTransaksi} />
        ) : (
          <NavbarBeforeLogin />
        )}
...
const mapStateToProps = (state) => {
  return {
    ...
    dataTransaksi: state.home.transaksi_seller,
  };
};
